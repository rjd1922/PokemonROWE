...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_DEOXYS_ATTACK, SPECIES_DEOXYS_DEFENSE, SPECIES_DEOXYS_SPEED, SPECIES_DIALGA,
    SPECIES_PALKIA, SPECIES_GIRATINA, SPECIES_GIRATINA_ORIGIN, SPECIES_MANAPHY,
    SPECIES_DARKRAI, SPECIES_SHAYMIN, SPECIES_SHAYMIN_SKY, SPECIES_ARCEUS,
    SPECIES_ARCEUS_FIGHTING, SPECIES_ARCEUS_FLYING, SPECIES_ARCEUS_POISON,
    SPECIES_ARCEUS_GROUND, SPECIES_ARCEUS_ROCK, SPECIES_ARCEUS_BUG, SPECIES_ARCEUS_GHOST,
    SPECIES_ARCEUS_STEEL, SPECIES_ARCEUS_FIRE, SPECIES_ARCEUS_WATER, SPECIES_ARCEUS_GRASS,
    SPECIES_ARCEUS_ELECTRIC, SPECIES_ARCEUS_PSYCHIC, SPECIES_ARCEUS_ICE,
    SPECIES_ARCEUS_DRAGON, SPECIES_ARCEUS_DARK, SPECIES_ARCEUS_FAIRY, SPECIES_VICTINI,
    SPECIES_RESHIRAM, SPECIES_ZEKROM, SPECIES_KYUREM, SPECIES_KYUREM_WHITE,
    SPECIES_KYUREM_BLACK, SPECIES_MELOETTA, SPECIES_GENESECT, SPECIES_GENESECT_DOUSE_DRIVE,
    SPECIES_GENESECT_SHOCK_DRIVE, SPECIES_GENESECT_BURN_DRIVE, SPECIES_GENESECT_CHILL_DRIVE,
    SPECIES_XERNEAS, SPECIES_YVELTAL, SPECIES_ZYGARDE, SPECIES_ZYGARDE_10,
    SPECIES_ZYGARDE_10_POWER_CONSTRUCT, SPECIES_ZYGARDE_50_POWER_CONSTRUCT,
    SPECIES_DIANCIE, SPECIES_HOOPA, SPECIES_HOOPA_UNBOUND, SPECIES_VOLCANION,
    SPECIES_COSMOG, SPECIES_COSMOEM, SPECIES_SOLGALEO, SPECIES_LUNALA, SPECIES_NECROZMA,
    SPECIES_NECROZMA_DUSK_MANE, SPECIES_NECROZMA_DAWN_WINGS, SPECIES_MAGEARNA,
    SPECIES_MAGEARNA_ORIGINAL_COLOR, SPECIES_MARSHADOW, SPECIES_ZERAORA, SPECIES_MELTAN,
    SPECIES_MELMETAL, SPECIES_ZACIAN, SPECIES_ZAMAZENTA, SPECIES_ETERNATUS, SPECIES_ZARUDE,
    SPECIES_CALYREX, SPECIES_CALYREX_ICE_RIDER, SPECIES_CALYREX_SHADOW_RIDER, 0xFFFF
};
